...
HD_PWD='C:/Users/Cyrill/Documents/S6/BA-GULFstream/Pynq Setup/pynq_setup_gulf_pll/pynq_setup_gulf_pll.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gulf_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gulf_top.tcl
