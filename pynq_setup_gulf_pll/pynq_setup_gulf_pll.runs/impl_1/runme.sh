...
HD_PWD='C:/Users/Cyrill/Documents/S6/BA-GULFstream/Pynq Setup/pynq_setup_gulf_pll/pynq_setup_gulf_pll.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gulf_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gulf_top.tcl -notrace
